...
<div id="carousel-example-2" class="carousel slide carousel-fade container" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="carousel-item active">
      <div class="view">
        <img class="d-block w-100" src="http://localhost/curture_page/main_page/main_imgs/slide1.png"
          alt="First slide">
    ...
    <div class="carousel-item">
      <!--Mask color-->
      <div class="view">
        <img class="d-block w-100" src="http://localhost/curture_page/main_page/main_imgs/slide2.png"
          alt="Second slide">
