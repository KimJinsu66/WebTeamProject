<?php
  ...
  if($review_no == null){
    ...
    if(isset($sql) && isset($sql2)){
      echo "<script>alert('삭제 되었습니다.'); location.href='http://localhost/WebTeamProject/curture_page/country/curture_main.php';</script>";
      
    } else {
      echo "<script>alert('삭제 실패'); location.href='http://localhost/WebTeamProject/curture_page/country/curture_main.php';</script>";
    }
